...
$info = getprogramm(id: htmlspecialchars(stripslashes(trim($_GET['id']))));
?>
<head>
    <meta charset="utf-8"/>
    <title>
...
<div id="div1">
    ...
    <div id="boxes">
        <div id="top">
            <img src=<?= $info["Imagesource"]; ?> class="boticon" onerror="this.onerror=null; this.src='Images/imgnotfound.png'" alt=""/>
