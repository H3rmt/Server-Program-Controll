...
!(function (t, e) {
    ...
    function Ue(t, e, i) {
        const n = i.box,
            o = t.maxPadding;
        U(i.pos) ||
            (i.size && (t[i.pos] -= i.size), (i.size = i.horizontal ? n.height : n.width), (t[i.pos] += i.size)),
    ...
    const fi = (t) => 0 === t || 1 === t,
        ...
        mi = {
            ...
            easeInOutExpo: (t) =>
                fi(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
                ...
                for (i = 0, n = t.length; i < n; ++i)
                    (a = s),
                        ...
                        s &&
                            ...
                            r && ((o.cp2x = fn(o.cp2x, e.left, e.right)), (o.cp2y = fn(o.cp2y, e.top, e.bottom))));
            })(t, i);
    }
    function pn(t, e, i, n) {
        ...
        return Pn(
            (function (t, e, i, n) {
                ...
                for (a = e + 1; a <= i; ++a) {
                    ...
                    i.skip || i.stop
                        ? l.skip ||
                          ((n = !1), s.push({ start: e % o, end: (a - 1) % o, loop: n }), (e = r = i.stop ? a : null))
                        : ((r = a), l.skip && (e = a)),
                        (l = i);
                }
    ...
    (go.id = "line"),
        (go.defaults = { datasetElementType: "line", dataElementType: "point", showLine: !0, spanGaps: !1 }),
    ...
    class Eo extends Ei {
        ...
        draw(t, e, i, n) {
            ...
            (o.points || []).length &&
                s.borderWidth &&
                (t.save(), Ro(t, o, i, n), t.restore(), o.animated && ((o._pointsUpdated = !1), (o._path = void 0)));
        }
    }
    function Io(t, e, i, n) {
        const o = t.options,
    ...
    function Vo(t) {
        ...
        const i = {};
        return e
            ? ((e = t.horizontal ? Bo(e, "left", "right", t.base > t.x) : Bo(e, "bottom", "top", t.base < t.y)),
              (i[e] = !0),
              i)
            : i;
    }
    ...
    class Rs extends Xi {
        ...
        parse(t, e) {
            ...
            return ((t, e) =>
                null === t
                    ? null
                    : Nt(Math.round(t), 0, e))((e = isFinite(e) && i[e] === t ? e : Ls(i, t, K(e, t))), i.length - 1);
        }
        determineDataLimits() {
            const t = this,
